// client/src/ProviderNavBar.jsx
import React, { useState } from 'react';
import { useNavigate } from "react-router-dom";
import { Link } from 'react-router-dom';
import './NavBar.css';

const ProviderNavBar = ({ isOpen, onToggle, onButtonClick }) => {
      ...
      <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <div>
          ...
          <button onClick={() => handleButtonClick(2)}>
            ...
            {isOpen ? <span>Create Job Post</span> : null}
        </button>
          <button onClick={() => handleButtonClick(3)}>
            <i className="fas fa-briefcase" style={{ marginRight: '5px' }}></i>
            {isOpen ? <span>Job Posted</span> : null}
          </button>
          ...
          <button onClick={() => handleButtonClick(4)}>
            ...
            {isOpen ? <span>Business Details</span> : null}
          </button>
