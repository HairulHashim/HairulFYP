                    ...
                    <div className="col-md-6">
                        ...
                        <div className="card">
                            ...
                            <FontAwesomeIcon icon={faUser} 
                                ...
                                <strong style={{marginLeft:"10px"}}>Worker Name: </strong> Ali Bin Abu<br></br><br></br>
                        ...
                        <div className="card">
                            ...
                            <FontAwesomeIcon icon={faUser} 
                                            style={{ fontSize: '100px', color: '#6c757d',  width: '50px', 
                                            height: '50px', borderRadius: '50%', objectFit: 'covern' }} />
                                <strong style={{marginLeft:"10px"}}>Worker Name: </strong> Abu Bin Norman<br></br><br></br>
                                <button style={{marginLeft:"10px"}}>Worker Details</button><br></br>
                                <button style={{marginLeft:"10px"}}>Worker Job History</button>
                            </div>
                        </div><br></br>
                        <div className="card">
                            ...
                            <FontAwesomeIcon icon={faUser} 
                                            style={{ fontSize: '100px', color: '#6c757d',  width: '50px', 
                                            height: '50px', borderRadius: '50%', objectFit: 'covern' }} />
                                <strong style={{marginLeft:"10px"}}>Worker Name: </strong> Amira Binti Ahmad<br></br><br></br>
                                <button style={{marginLeft:"10px"}}>Worker Details</button><br></br>
                                <button style={{marginLeft:"10px"}}>Worker Job History</button>
                            </div>
                        </div><br></br>
                        <div className="card">
                            ...
                            <FontAwesomeIcon icon={faUser} 
                                            style={{ fontSize: '100px', color: '#6c757d',  width: '50px', 
                                            height: '50px', borderRadius: '50%', objectFit: 'covern' }} />
                                <strong style={{marginLeft:"10px"}}>Worker Name: </strong> Alia Bin Syakir<br></br><br></br>
                                <button style={{marginLeft:"10px"}}>Worker Details</button><br></br>
                                <button style={{marginLeft:"10px"}}>Worker Job History</button>
                            </div>
                        </div><br></br>
