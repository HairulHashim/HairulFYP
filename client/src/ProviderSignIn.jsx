...
function ProviderSignIn() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:3001/providers/signIn', { email, password });
            if (response.data.status === "Success") {
                sessionStorage.setItem('jwtToken', response.data.token);
                sessionStorage.setItem('providerDetails', JSON.stringify(response.data.provider));
                
                navigate('/ProviderHomePage', { replace: true });
            ...
            <div className="row">
                ...
                <div className="col-md-6 position-relative">
                    <div className='my-5 bg-glass'>
                        ...
                        <h3 style={{ backgroundColor: '#FFFFFF', color: '#92A8D1' }}>Job Provider Sign In</h3>
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="text-center">
                                            <p>Do not have Account. <Link to="/ProviderSignUp">Sign Up Here</Link></p>
